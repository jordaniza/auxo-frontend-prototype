...
import type { Mono, MonoInterface } from "../Mono";
...
export class Mono__factory {
  static readonly abi = _abi;
  static createInterface(): MonoInterface {
    return new utils.Interface(_abi) as MonoInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Mono {
    return new Contract(address, _abi, signerOrProvider) as Mono;
  }
}
