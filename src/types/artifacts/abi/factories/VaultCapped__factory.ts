...
import type { VaultCapped, VaultCappedInterface } from "../VaultCapped";
...
export class VaultCapped__factory {
  static readonly abi = _abi;
  static createInterface(): VaultCappedInterface {
    return new utils.Interface(_abi) as VaultCappedInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VaultCapped {
    return new Contract(address, _abi, signerOrProvider) as VaultCapped;
  }
}
